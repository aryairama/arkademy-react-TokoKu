...
const Navbar = (props) => {
  ...
  return (
    <nav className={`navbar ${expand} navbar-light bg-white shadow fixed-top`}>
      <div className="container">
        <Link to={props.urlLogo} className="navbar-brand d-flex">
          <img
            className="brand-ecommerce"
            src={props.urlLogoImg}
            alt="logo-app"
          />
          <p className="text-logo-ecommerce mb-n5 pt-2 ps-1">
            {props.textLogo}
          </p>
        </Link>
        <button
        ...
        <div className="collapse navbar-collapse" id="navbar-ecommerce">
          <div className="row flex-grow-1 mt-md-2 mt-4">
            ...
            <div className="col-md-6 col-lg-6 col-12">{props.rigthMenu}</div>
          </div>
        </div>
      </div>
    </nav>
